...
const SETTING_OPTIONS: NavListItemData[] = [
  ...
  { link: './perils-of-the-warp', label: 'Arcane Perils', permission: PermissionId.ADMIN_SETTING },
  { link: './psychic-disciplines', label: 'Arcane Disciplines', permission: PermissionId.ADMIN_SETTING },
  { link: './psychic-phenomenas', label: 'Arcane Phenomenas', permission: PermissionId.ADMIN_SETTING },
  { link: './psychic-powers', label: 'Arcane Powers', permission: PermissionId.ADMIN_SETTING },
