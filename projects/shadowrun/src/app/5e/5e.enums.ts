...
export enum GEAR_ID {
  ...
  BOW = 'gt:bow',
  ARROW = 'gt:arrow',
  INJECTION_ARROW = 'gt:injection_arrow',
  LIGHT_CROSSBOW = 'gt:light_crossbow',
  MEDIUM_CROSSBOW = 'gt:medium_crossbow',
  HEAVY_CROSSBOW = 'gt:heavy_crossbow',
  BOLT = 'gt:bolt',
  INJECTION_BOLT = 'gt:injection_bolt',
  THROWING_KNIFE = 'gt:throwing_knife',
  SHURIKEN = 'gt:shuriken',
  DEFIANCE_EX_SHOCKER = 'gt:defiance_ex_shocker',
  YAMAHA_PULSAR = 'gt:yamaha_pulsar',
  FICHETTI_TIFFANI_NEEDLER = 'gt:fichetti_tiffani_needler',
  STREETLINE_SPECIAL = 'gt:streetline_special',
  WALTHER_PALM_PISTOL = 'gt:walther_palm_pistol',
  ARES_LIGHT_FIRE_75 = 'gt:ares_light_fire_75',
  ARES_LIGHT_FIRE_70 = 'gt:ares_light_fire_70',
  BERETTA_201T = 'gt:beretta_201t',
  COLT_AMERICA_L36 = 'gt:colt_america_l36',
  FICHETTI_SECURITY_600 = 'gt:fichetti_security_600',
  TAURUS_OMNI_6 = 'gt:taurus_omni_6',
  ARES_PREDATOR_V = 'gt:ares_predator_v',
  ARES_VIPER_SLIVERGUN = 'gt:ares_viper_slivergun',
  BROWNING_ULTRA_POWER = 'gt:browning_ultra_power',
  COLT_GOVERNMENT_2066 = 'gt:colt_government_2066',
  REMINGTON_ROOMSWEEPER = 'gt:remington_roomsweeper',
  RUGER_SUPER_WARHAWK = 'gt:ruger_super_warhawk',
  // SHOCK_GLOVES = 'gt:shock_gloves',
  // SHOCK_GLOVES = 'gt:shock_gloves',
  // SHOCK_GLOVES = 'gt:shock_gloves',
  // SHOCK_GLOVES = 'gt:shock_gloves',
...
export enum GEAR_TYPE_ID {
  ...
  BLADES = 'gt:blades',
  CLUBS = 'gt:clubs',
  OTHER_MELEE = 'gt:other_melee',
  BOWS = 'gt:bows',
  CROSSBOWS = 'gt:crossbows',
  THROWING_WEAPONS = 'gt:throwing_weapons',
  TASERS = 'gt:tasers',
  HOLD_OUTS = 'gt:hold_outs',
  LIGHT_PISTOLS = 'gt:light_pistols',
  HEAVY_PISTOLS = 'gt:heavy_pistols',
}
