...
export const SKILLS: Skill[] = [
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nIdentify an unknown alchemical\n(Easy +20%):\nAssemble an alchemical laboratory\n(Routine +10%):\nCreate one dose of a poultice or blackpowder\n(Standard +/-0%):\nCreate two doses of a poultice or blackpowder\n(Challenging -10%):\nCreate three doses of a poultice or blackpowder\n(Hard -20%):\nBrew rare alchemical mixtures\n(Arduous -30%):\nBrew a true panacea'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nClimb up a tree with many branches\n(Easy +20%):\nSwim while wearing summer clothing\n(Routine +10%):\nJump over a pit while wearing heavy clothing\n(Standard +/-0%):\nRow a boat through rapid water\n(Challenging -10%):\nPush an object three times your weight\n(Hard -20%):\nPull a coach stuck in the mud out with the aid of a horse\n(Arduous -30%):\nClimb the sheer face of a cliff'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nListen for sounds through a thin door\n(Easy +20%):\nSmell a distinct spice in a dish\n(Routine +10%):\nSpot an obvious snare\n(Standard +/-0%):\nStand watch at a campfire on a clear night\n(Challenging -10%):\nFind someone obscured by mist or darkness\n(Hard -20%):\nEstimate the total value of a mountain of coins quickly\n(Arduous -30%):\nSpot a trap camouflaged almost perfectly into the forest'
    }
  },
  {
    id: SkillId.BARGAIN,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nEvaluate the worth of a gem or finery you procured\n(Easy +20%):\nBroker a trade deal between two merchants\n(Routine +10%):\nInterpret the profit and loss of a major financial deal\n(Standard +/-0%):\nProcure black market goods from a fence\n(Challenging -10%):\nFind common ground between two people of different Allegiances\n(Hard -20%):\nConvince an innkeeper not to report criminal mischief on your part\n(Arduous -30%):\nBribe the local watch to walk away from the scene of a crime'
    }
  },
  {
    id: SkillId.CHARM,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nWhistle or sing a popular song in tune\n(Easy +20%):\nRemember and retell a funny joke\n(Routine +10%):\nRecite a famous story before an audience\n(Standard +/-0%):\nRead poetry with a straight face in front of a lover\n(Challenging -10%):\nSeduce someone outside of your Allegiance\n(Hard -20%):\nPick up an instrument you’ve never played and learn a song\n(Arduous -30%):\nSeduce someone who does not share your values'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nCatch a small object in hand as it falls\n(Easy +20%):\nWalk across a tree log over a river\n(Routine +10%):\nJuggle otherwise innocuous objects\n(Standard +/-0%):\nLeap across a campfire\n(Challenging -10%):\nPerform an intricate dance among other cultures\n(Hard -20%):\nTwist your body to fit into a very small space\n(Arduous -30%):\nContort your wrists to escape bonds or manacles'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nCreate a simple reproduction of a ring or other item of finery\n(Easy +20%):\nCraft a false estimate of work to collect pay\n(Routine +10%):\nClip coins, producing 1 new one from the pieces of 9 others\n(Standard +/-0%):\nPass off a painted wooden token as a gold piece\n(Challenging -10%):\nForge a signature\n(Hard -20%):\nReproduce an intricate artwork without the skills necessary to do so\n(Arduous -30%):\nPerfectly reproduce someone else’s writing'
    }
  },
  {
    id: SkillId.DISGUISE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nConvincingly act as another in a cheap play\n(Easy +20%):\nPretend to be someone of a different Allegiance\n(Routine +10%):\nCreate a false identity and live behind it\n(Standard +/-0%):\nImpersonate someone from a foreign land\n(Challenging -10%):\nConvincingly act as another in a well-known playhouse\n(Hard -20%):\nImpersonate another’s personal appearance\n(Arduous -30%):\nPerfectly impersonate another person in looks and voice'
    }
  },
  {
    id: SkillId.DRIVE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nDrive a wagon overland during fair weather\n(Easy +20%):\nBreak through a low barrier or over a hedge on horseback\n(Routine +10%):\nTrek overland during inclement weather\n(Standard +/-0%):\nRace by cart and horse\n(Challenging -10%):\nTake a vehicle off-road and across country\n(Hard -20%):\nJump a vehicle from one road to another\n(Arduous -30%):\nFord a deep river with a vehicle'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nListen in to a conversation next to you\n(Easy +20%):\nHide your lips from being read by others\n(Routine +10%):\nUse hand signals to indicate simple thoughts\n(Standard +/-0%):\nRead a person’s lips from across a well-lit room\n(Challenging -10%):\nListen to a conversation through a wooden door\n(Hard -20%):\nRead a person’s lips through fleeting shadows\n(Arduous -30%):\nListen to a conversation through a metal door'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nUnderstand local laws\n(Easy +20%):\nIdentify specific constellations in the night sky\n(Routine +10%):\nKnow a specific leader of another province\n(Standard +/-0%):\nUnderstand the relationships between gods\n(Challenging -10%):\nIdentify the flags of rival nations\n(Hard -20%):\nTranslate ancient writings into your own tongue\n(Arduous -30%):\nUnderstand the difference between a Ghast and a Ghoul'
    }
  },
  {
    id: SkillId.FOLKLORE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nInterpret the funerary practices of locals\n(Easy +20%):\nUse the proper courtesies of other cultures\n(Routine +10%):\nIdentify a local landmark and its importance\n(Standard +/-0%):\nRecall legends from history\n(Challenging -10%):\nKnow about local flora and fauna\n(Hard -20%):\nIdentify a famous person from their burial marker\n(Arduous -30%):\nForecast the weather based on historic patterns'
    }
  },
  {
    id: SkillId.GAMBLE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nPlay and win a game of cards against greenhorns\n(Easy +20%):\nFix a cockfight in your favor\n(Routine +10%):\nPlay and win a standard game of chess\n(Standard +/-0%):\nGuess the number of stones in a large jar\n(Challenging -10%):\nFix a fistfight in your favor\n(Hard -20%):\nPlay and win a game of dice against a veteran gambler\n(Arduous -30%):\nGuess the next card to be played'
    }
  },
  {
    id: SkillId.GUILE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nBluster and blather your way out of responsibility\n(Easy +20%):\nUse innuendo to imply one thing while saying another\n(Routine +10%):\nEngage in wordplay with another to appear smarter\n(Standard +/-0%):\nBlend into the crowd to look innocuous and harmless\n(Challenging -10%):\nBluff your way into a Red Coat compound\n(Hard -20%):\nUnderstand Thieves’ Cant in the middle of hostile repartee\n(Arduous -30%):\nAppear innocent of a crime you clearly committed'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nShoe a horse or groom a domestic animal\n(Easy +20%):\nTeach a simple trick to an animal, like fetch, lie down or sit\n(Routine +10%):\nRustle a flock of sheep without a sheepdog\n(Standard +/-0%):\nCalm a frightened horse\n(Challenging -10%):\nBreak a young horse for riding\n(Hard -20%):\nCalm a frightened stampede of wild cattle\n(Arduous -30%):\nBreak a wild horse for riding'
    }
  },
  {
    id: SkillId.HEAL,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nTreat Typhoid in a patient\n(Easy +20%):\nPerform a Trepanation on someone\n(Routine +10%):\nTreat an Injury to begin its recuperation\n(Standard +/-0%):\nTreat an Ailment in a patient\n(Challenging -10%):\nTreat Heatstroke on an Injured person\n(Hard -20%):\nTreat deadly Ailments in a Grievously Wounded patient\n(Arduous -30%):\nUse a Kiss of Life on someone who is at death’s door'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nCast a spell in a place regarded as holy to your faith\n(Easy +20%):\nInterpret a person’s future based on their personality quirks\n(Routine +10%):\nCast a spell upon an unsuspecting target while hidden\n(Standard +/-0%):\nCast a spell as foes are Charging toward you\n(Challenging -10%):\nHypnotize a willing subject\n(Hard -20%):\nCast a spell when miscasting could harm your friends\n(Arduous -30%):\nCast a spell in the midst of a riot'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nGaslight a friend or loved one\n(Easy +20%):\nPour hot tar over someone\n(Routine +10%):\nStrike the head off of the guilty in one stroke\n(Standard +/-0%):\nForce a witness to relive a traumatic experience\n(Challenging -10%):\nConvince someone to tell the truth, after a round of torture\n(Hard -20%):\nTorture a friend or an ally\n(Arduous -30%):\nTorture the truly innocent'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nBully your way to the front of a soup line\n(Easy +20%):\nInsinuate violence through force of presence and words\n(Routine +10%):\nCause innocent people to cow before you in a public place\n(Standard +/-0%):\nShove or push someone out of your way\n(Challenging -10%):\nCow foes into giving up\n(Hard -20%):\nMake a threatening gesture to force a guard to abandon their post\n(Arduous -30%):\nForce an undefeated rival to kiss your boots'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nLift the spirits of a close friend in the wake of harm\n(Easy +20%):\nSpread rumors and news among a crowd of people\n(Routine +10%):\nUse Words As Weapons when you’re Hurt\n(Standard +/-0%):\nConvince your flock to change their principles\n(Challenging -10%):\nCommand a military campaign to besiege a stronghold\n(Hard -20%):\nUplift a congregation which has lost its faith in God\n(Arduous -30%):\nConvince an enemy Allegiance to fight alongside you'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nHit a foe who’s Prone on the ground\n(Easy +20%):\nUse a Counterattack against an enemy who’s moving away\n(Routine +10%):\nFlank foes that are outnumbered in a melee engagement\n(Standard +/-0%):\nFight toe-to-toe with an evenly matched aggressor\n(Challenging -10%):\nStrike someone in fog, mist or smoke\n(Hard -20%):\nParry a two-handed weapon using a knife\n(Arduous -30%):\nStrike someone in the dark'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nFire a shot at a foe who’s climbing a tree\n(Easy +20%):\nFire and land a shot in the outer rings of a stationary target\n(Routine +10%):\nFire a shot from higher ground\n(Standard +/-0%):\nFire a shot at someone who’s unprotected by cover\n(Challenging -10%):\nFire at someone standing in fog, mist or smoke or on horseback\n(Hard -20%):\nFire a ranged weapon into an Engagement with allies nearby\n(Arduous -30%):\nFire at a foe in the dark'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nDetermine true north on a cloudy day\n(Easy +20%):\nDiscern the constellations to guide your journey by sea\n(Routine +10%):\nChart out an overland route lasting several days\n(Standard +/-0%):\nIdentify foreign landmarks to make your way without a map\n(Challenging -10%):\nChart out an overland route lasting several weeks\n(Hard -20%):\nRealign your travels after getting lost for days in the wilderness\n(Arduous -30%):\nDetermine true north below ground'
    }
  },
  {
    id: SkillId.PILOT,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nMaintain the integrity of any water-going vessel\n(Easy +20%):\nPilot a ship in calm conditions by sea\n(Routine +10%):\nSail a riverboat through rapids\n(Standard +/-0%):\nRight a boat that’s being spun out of control by a river eddy\n(Challenging -10%):\nPilot a ship in stormy conditions by sea\n(Hard -20%):\nAssure that cargo arrives unmolested if sent across a rough sea\n(Arduous -30%):\nRight a boat that’s threatening to be swallowed by the sea'
    }
  },
  {
    id: SkillId.RESOLVE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nMaintain your cool when piloting or driving a vehicle in a tense situation\n(Easy +20%):\nWithstand the effects of Stress\n(Routine +10%):\nIgnore the impact of spells which may cause anxiety\n(Standard +/-0%):\nWithstand the effects of Fear\n(Challenging -10%):\nWithstand being intimidated by out-of-touch aristocrats\n(Hard -20%):\nWithstand the effects of Terror\n(Arduous -30%):\nSteel yourself before a legendary beast'
    }
  },
  {
    id: SkillId.RIDE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nRide a horse in the water as it swims\n(Easy +20%):\nBreak from a gallop into a charge\n(Routine +10%):\nRide a horse from village to village at fast speeds\n(Standard +/-0%):\nPerform simple tricks\n(Challenging -10%):\nDrop from a window into the saddle\n(Hard -20%):\nJump over hedges at a gallop\n(Arduous -30%):\nTake control and ride a threat that’s classified as a Beast'
    }
  },
  {
    id: SkillId.RUMOR,
  ...
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nRemember what you had to eat the previous day\n(Easy +20%):\nRead body language to understand the Allegiance of another\n(Routine +10%):\nDecode a secret message in your own tongue\n(Standard +/-0%):\nRemember an important task you forgot to attend to\n(Challenging -10%):\nDecode a secret message in a foreign tongue\n(Hard -20%):\nMemorize the order of events after a deadly fight\n(Arduous -30%):\nDetermine if someone with whom you aren’t familiar is telling lies'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nRe-wrap leather around the hilt of a broken saber\n(Easy +20%):\nStrike a foe who is sitting in their chair with their back turned toward you\n(Routine +10%):\nUse your weapon alternatively as a tool for work\n(Standard +/-0%):\nGrapple the haft of a boarding axe to bash a door down\n(Challenging -10%):\nBreak a Simple Melee weapon over your knee\n(Hard -20%):\nDig a shallow grave using your weapon\n(Arduous -30%):\nScavenge a Simple Melee weapon to become usable'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nFire a shot at a person who’s climbing a tree\n(Easy +20%):\nFire a shot at someone who’s running away\n(Routine +10%):\nFire a shot at a foe who’s pinned against a wall or in the corner\n(Standard +/-0%):\nFire a warning shot at someone’s feet\n(Challenging -10%):\nFire a shot at someone on horseback\n(Hard -20%):\nFire into an Engagement, where you may potentially harm your allies\nK (Arduous -30%):\nFire at an enemy in darkness'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nUse a simple card trick to distract others\n(Easy +20%):\nFilch a pie off a windowsill\n(Routine +10%):\nDisable a wire trap intended to set off an alarm\n(Standard +/-0%):\nPick the pocket of a passerby in a crowded street\n(Challenging -10%):\nPick the lock off a strongbox or fortified trunk\n(Hard -20%):\nPick the pocket of a passerby in a near- empty street\n(Arduous -30%):\nPalm an object in front of a merchant’s stall'
    }
  },
  {
    id: SkillId.STEALTH,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nMove quietly, so as to not awaken your enemies\n(Easy +20%):\nStalk someone through a crowded street\n(Routine +10%):\nReconnoiter the rim of a mining deposit\n(Standard +/-0%):\nSet up a good vantage point to waylay a Red Coat baggage train\n(Challenging -10%):\nShadow an animal through the woods\n(Hard -20%):\nMove quietly, so as to not awaken your children\n(Arduous -30%):\nHide in plain sight'
    }
  },
  {
    id: SkillId.SURVIVAL,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nGo fishing with adequate supplies\n(Easy +20%):\nForage for roots and berries in the wild\n(Routine +10%):\nBuild a shelter out of limbs and grass\n(Standard +/-0%):\nConstruct an improvised weapon\n(Challenging -10%):\nTrack a small animal’s prints\n(Hard -20%):\nTrack the passing of a single person through the wilderness\n(Arduous -30%):\nFind a source of water in the deep desert'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nResist the effects of sickness after a bad meal\n(Easy +20%):\nResist the effects of Ailments after robbing the interred dead\n(Routine +10%):\nWithstand one dose of Throat Distemper\n(Standard +/-0%):\nResist the effects of Morsal\n(Challenging -10%):\nWithstand the effects of French Pox\n(Hard -20%):\nWithstand Intoxication after drinking for six hours\n(Arduous -30%):\nGet back on your feet after falling off a house'
    }
  },
  {
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nMeltdown or repurpose materials from destroyed objects\n(Easy +20%):\nMake minor repairs and restore an item to like-new condition\n(Routine +10%):\nConduct the last repairs to restore an object from the Ruined! Quality\n(Standard +/-0%):\nCreate an object with minimal materials and no stressors\n(Challenging -10%):\nMimic someone else’s work to appear as your own\n(Hard -20%):\nInvent a new ware or weapon\n(Arduous -30%):\nRepair a Kentucky Longrifle that’s been busted into tiny, tiny pieces'
    }
  },
  {
    id: SkillId.WARFARE,
    ...
    labels: {
      ...
      difficulties: '(Trivial +30%):\nTake account of supplies and provisions for a war campaign\n(Easy +20%):\nLoad a war machine with assistance\n(Routine +10%):\nDetermine weaknesses in enemy lines\n(Standard +/-0%):\nConduct a massive troop movement in the midst of battle\n(Challenging -10%):\nFind soft spots in fortifications\n(Hard -20%):\nPrognosticate the tactics an unknown enemy is using\n(Arduous -30%):\nCount the number of troops remaining on a battlefield'
    }
  },
];
