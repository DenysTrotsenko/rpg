...
export enum ThreatId {
  ...
  FREEMASON_AGENT,
  FREEMASON_ALCHEMIST,
  FREEMASON_ENTERED_APPRENTICE,
  FREEMASON_FELLOWCRAFT,
  FREEMASON_MASTER,
  GARGANTUAN_SPIDER,
  GHOUL,
  GOLEM,
  ...
  INQUISITION_AGENT,
  INQUISITION_FISCAL,
  INQUISITION_WITCH_HUNTER,
  INSECT_SWARM,
  JOURNALIST,
  KNIGHTS_TEMPLAR_INITIATE,
  KNIGHTS_TEMPLAR_NOBLE,
  KNIGHTS_TEMPLAR_SERGEANT,
  KNIGHTS_TEMPLAR_SQUIRE,
  KNOCKER,
  KRAKEN,
  LABORER,
  LADY_IN_WHITE,
...
export enum WareId {
  ...
  LAUDANUM,
  OPIUM,
  PORTABLE_ALCHEMICAL_LABORATORY,
  PROSTHETIC_FOOT,
  PROSTHETIC_HAND,
  PROSTHETIC_JOINT,
  PROSTHETIC_LEG,
