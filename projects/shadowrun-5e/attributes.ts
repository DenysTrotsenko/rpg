...
import { ATTRIBUTE_ID, ATTRIBUTE_TYPE_ID } from './enums';

export const ATTRIBUTES: Attribute[] = [
  {
    id: ATTRIBUTE_ID.BODY,
    name: 'Body',
    type: ATTRIBUTE_TYPE_ID.PHYSICAL,
    labels: {
      alias: 'BOD',
  ...
  {
    id: ATTRIBUTE_ID.WILLPOWER,
    name: 'Willpower',
    type: ATTRIBUTE_TYPE_ID.MENTAL,
    labels: {
      alias: 'WIL',
  ...
  {
    id: ATTRIBUTE_ID.EDGE,
    name: 'Edge',
    type: ATTRIBUTE_TYPE_ID.SPECIAL,
    labels: {
      alias: 'EDG',
